...
#define DRV_NAME "tegra-snd-t186ref-mobile-phaedra"
					...
					bool is_playback)
{
	...
	idx = tegra_machine_get_codec_dai_link_idx_t18x("aic3206-playback");
...
static int tegra_t186ref_driver_probe(struct platform_device *pdev)
{
	...
	fsa8500_set_hs_jack(&tegra_t186ref_hp_jack);
...
MODULE_DESCRIPTION("Magic Leap Phaedra ASoC machine driver");
