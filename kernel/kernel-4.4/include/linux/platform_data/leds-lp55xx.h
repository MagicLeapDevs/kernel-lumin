 ...
 * @pat_data:         : Pattern data memory pointer for suspend pattern
 * @charging_mode_active: True when device is in charging mode
...
struct lp55xx_platform_data {
	...
	/* Charging mode enabled */
	bool charging_mode_active;
