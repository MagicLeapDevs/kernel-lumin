 ...
 *
 * $Id: dhd_common.c 761976 2018-05-10 06:33:56Z $
 */
#include <typedefs.h>
#include <osl.h>
...
int dhd_msg_level = DHD_ERROR_VAL | DHD_MSGTRACE_VAL | DHD_FWLOG_VAL | DHD_ERROR_MEM_VAL;
	...
	if (hdr->log_magic == LOGSTRS_MAGIC) {
		...
		*/
		if (hdr->version == 1) {
			...
			DHD_ERROR(("Invalid logstr header version\n"));
			return BCME_ERROR;
		}
	} else {
		/*
