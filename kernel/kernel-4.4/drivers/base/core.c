...
/**
 * device_link_remove - Deletes the device link between 2 devices if it exists.
 * @consumer: Consumer device.
 * @supplier: Supplier device.
 *
 * This func will find a link between supplier and consumer and remove it.
 */
void device_link_remove(struct device *consumer, struct device *supplier)
{
	...
	list_for_each_entry_safe_reverse(link, ln, &consumer->links.suppliers, c_node)
