...
enum opt_code
{
  ...
  OPT_mabi_ = 1124,                          /* -mabi= */
  OPT_mandroid = 1125,                       /* -mandroid */
  OPT_march_ = 1126,                         /* -march= */
  OPT_mbig_endian = 1127,                    /* -mbig-endian */
  OPT_mbionic = 1128,                        /* -mbionic */
  OPT_mcmodel_ = 1129,                       /* -mcmodel= */
  OPT_mcpu_ = 1130,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1131,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1132,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1133,             /* -mgeneral-regs-only */
  OPT_mglibc = 1134,                         /* -mglibc */
  OPT_mlittle_endian = 1135,                 /* -mlittle-endian */
  OPT_mlra = 1136,                           /* -mlra */
  OPT_momit_leaf_frame_pointer = 1137,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1138,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1139,                  /* -mtls-dialect= */
  OPT_mtune_ = 1140,                         /* -mtune= */
  OPT_muclibc = 1141,                        /* -muclibc */
  OPT_n = 1142,                              /* -n */
  OPT_no_canonical_prefixes = 1143,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1144,              /* -no-integrated-cpp */
  OPT_no_pie = 1145,                         /* -no-pie */
  OPT_nocpp = 1146,                          /* -nocpp */
  OPT_nodefaultlibs = 1147,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1148,                   /* -nostartfiles */
  OPT_nostdinc = 1149,                       /* -nostdinc */
  OPT_nostdinc__ = 1150,                     /* -nostdinc++ */
  OPT_nostdlib = 1151,                       /* -nostdlib */
  OPT_o = 1152,                              /* -o */
  OPT_p = 1153,                              /* -p */
  OPT_pass_exit_codes = 1154,                /* -pass-exit-codes */
  /* OPT_pedantic = 1155, */                 /* -pedantic */
  OPT_pedantic_errors = 1156,                /* -pedantic-errors */
  OPT_pg = 1157,                             /* -pg */
  OPT_pie = 1158,                            /* -pie */
  OPT_pipe = 1159,                           /* -pipe */
  OPT_posix = 1160,                          /* -posix */
  OPT_print_file_name_ = 1161,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1162,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1163,          /* -print-multi-directory */
  OPT_print_multi_lib = 1164,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1165,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1166,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1167,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1168,               /* -print-prog-name= */
  OPT_print_search_dirs = 1169,              /* -print-search-dirs */
  OPT_print_sysroot = 1170,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1171,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1172,                        /* -profile */
  OPT_pthread = 1173,                        /* -pthread */
  ...
  OPT_static_libstdc__ = 1193,               /* -static-libstdc++ */
  OPT_static_libtsan = 1194,                 /* -static-libtsan */
  OPT_static_libubsan = 1195,                /* -static-libubsan */
  /* OPT_std_c__03 = 1196, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1197, */                /* -std=c++0x */
  OPT_std_c__11 = 1198,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1199, */                /* -std=c++14 */
  OPT_std_c__1y = 1200,                      /* -std=c++1y */
  OPT_std_c__98 = 1201,                      /* -std=c++98 */
  OPT_std_c11 = 1202,                        /* -std=c11 */
  /* OPT_std_c1x = 1203, */                  /* -std=c1x */
  /* OPT_std_c89 = 1204, */                  /* -std=c89 */
  OPT_std_c90 = 1205,                        /* -std=c90 */
  OPT_std_c99 = 1206,                        /* -std=c99 */
  /* OPT_std_c9x = 1207, */                  /* -std=c9x */
  OPT_std_f2003 = 1208,                      /* -std=f2003 */
  OPT_std_f2008 = 1209,                      /* -std=f2008 */
  OPT_std_f2008ts = 1210,                    /* -std=f2008ts */
  OPT_std_f95 = 1211,                        /* -std=f95 */
  OPT_std_gnu = 1212,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1213, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1214, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1215,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1216, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1217,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1218,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1219,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1220, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1221, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1222,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1223,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1224, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1225, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1226,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1227, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1228, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1229, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1230,                     /* -std=legacy */
  OPT_symbolic = 1231,                       /* -symbolic */
  OPT_t = 1232,                              /* -t */
  OPT_time = 1233,                           /* -time */
  OPT_time_ = 1234,                          /* -time= */
  OPT_tno_android_cc = 1235,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1236,                 /* -tno-android-ld */
  OPT_traditional = 1237,                    /* -traditional */
  OPT_traditional_cpp = 1238,                /* -traditional-cpp */
  OPT_trigraphs = 1239,                      /* -trigraphs */
  OPT_u = 1240,                              /* -u */
  OPT_undef = 1241,                          /* -undef */
  OPT_v = 1242,                              /* -v */
  OPT_version = 1243,                        /* -version */
  OPT_w = 1244,                              /* -w */
  OPT_wrapper = 1245,                        /* -wrapper */
  OPT_x = 1246,                              /* -x */
  OPT_z = 1247,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
